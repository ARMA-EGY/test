    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        <a class="navbar-brand" href="javascript:void(0)">
          <img src="https://www.armasoftware.com/images/arma_logo.png" class="navbar-brand-img" style="width: 110px; max-height:unset;" alt="...">
        </a>
      </div>
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{request()->routeIs('calendar') ? 'active' : '' }}" href="/calendar">
            ...
            <li class="nav-item">
              <a class="nav-link {{request()->is('messages') ? 'active' : '' }}" href="/messages">
                <i class="ni ni-email-83 text-red"></i>
                <span class="nav-link-text">Messages</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{request()->is('print') ? 'active' : '' }}" href="/print">
                <i class="fa fa-paste text-pink"></i>
                <span class="nav-link-text">Print Prices</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{request()->is('visits') ? 'active' : '' }}" href="/visits">
                <i class="ni ni-vector text-purple"></i>
                <span class="nav-link-text">Pages Visits</span>
              </a>
            </li>
          </ul>
          <!-- Divider -->
          <hr class="my-3" style="border-top:1px solid rgb(255 255 255 / 50%);">
          <!-- Heading -->
